...
{
    public class ApplicantUserController : Controller
    {
        private INAAService _naaService;
        public ApplicantUserController()
        {
            _naaService = new NAAService();
        }
        // GET: User
        public ActionResult Users()
        {
            return View(_naaService.GetApplicants());
        }
